...
Should you wish to override the tablet layout and use a phone layout instead, copy and paste this into a resource file (typically bools.xml): `<bool name="forcePhone">true</bool>`
