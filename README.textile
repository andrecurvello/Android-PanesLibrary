...
Note, this library was built by the "Mapsaurus":http://www.mapsaurus.com team. Mapsaurus is an interactive map of the Android app world. We algorithmically create connections between related apps and enable the user to explore and discover by following these connections. Follow us on Twitter "@Mapsaurus":https://twitter.com/Mapsaurus for more on PanesLibrary and our app!
...
Should you wish to override the tablet layout and use a phone layout instead, copy and paste this into a resource file (typically bools.xml): <code><bool name="forcePhone">true</bool></code>
